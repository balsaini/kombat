...
class CreateCreatureApp extends React.Component {
  constructor(props) {
    super(props);
    console.log('Create Creature App Constructor');
    // this.state = { sections: [] };
  ...
  render() {
    return (
      <div>
        <div className='creatureCreate'>
          <div className='col-xs-8'>
            <CreatureCreator ref='creature' para1={this.create} />
          </div>
        </div>
      </div>
    );
...
export default CreateCreatureApp;
